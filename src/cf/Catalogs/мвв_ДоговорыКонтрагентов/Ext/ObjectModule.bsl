// ОРТИКОН НАЧАЛО------------------------------------------------------
Перем мВыполнятьПроверки Экспорт;      //  условие
// ОРТИКОН КОНЕЦ-------------------------------------------------------
...
Процедура ПередЗаписью(Отказ)
	...
	Если ВидДеятельностиПоСтрахованию.Пустая() Тогда
		ВидДеятельностиПоСтрахованию = Перечисления.ус_ВидыДеятельностиПоСтрахованию.Общехозяйственный;	
	КонецЕсли; 
		
	Если мВыполнятьПроверки Тогда
        ПроверитьПередЗаписью(Отказ, Истина);
	КонецЕсли;
	// ОРТИКОН КОНЕЦ-------------------------------------------------------
...
// Процедура-обработчик "ПриЗаписи"
//
// Параметры
//	Нет
//
Процедура ПриЗаписи(Отказ)
	Если ЗначениеЗаполнено(Договор) Тогда
		Если ПометкаУдаления <> Договор.ПометкаУдаления Тогда
			ДоговорОбъект = Договор.ПолучитьОбъект();
			ДоговорОбъект.УстановитьПометкуУдаления(ПометкаУдаления);
		КонецЕсли;
	КонецЕсли;
КонецПроцедуры // ПриЗаписи(Отказ)
 
мВыполнятьПроверки = Истина;
// ОРТИКОН КОНЕЦ-------------------------------------------------------
